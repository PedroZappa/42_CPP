...
/**
 * @file main.cpp
 * @brief This file contains the main function to demonstrate the usage of the
 * easyfind function.
 *
 * The program fills a vector and a list with integers and attempts to find
 * specific values using the easyfind function. It demonstrates exception
 * handling when a value is not found.
 *
 * @author passunca
 * @date 2024-12-14
 */
...
int main(void) {
	...
	// Try Vector
	try {
		std::cout << "Searching for " BBLU << toSearch << NC " on vector"
				  << std::endl;
	...
	// Try List
	try {
		std::cout << "Searching for " BBLU << outOfRange << NC " on list"
				  << std::endl;
